...
As of v2.5.0-beta.6, AI PPT configuration is on **Capabilities & integrations → AI PPT** (`/admin/ai-ppt`). That page owns the Docmee connection, enable switch, presentation prices, templates, and vendor balance. The platform-wide credit conversion and general limits remain here; the two pages save their own settings independently.
