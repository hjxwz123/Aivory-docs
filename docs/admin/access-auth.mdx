...
Aivory v2.4.6 and later. Relevant screens: "Users & access → Users / Registration policy / Login methods / Workspaces". Proxy and HTTPS prerequisites: [Domain, HTTPS, and OAuth](../deployment/domain-tls-oauth.mdx). Screenshots show the Chinese admin UI; English labels are cited inline.
