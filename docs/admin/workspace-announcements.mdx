...
This feature is available in the `v2.4.9-beta.1` test release. It is a pre-release rather than a stable production release; use it for testing and validate it in a non-production environment before relying on it.
...
The editor controls use the administrator's selected UI language in English, Simplified Chinese, Traditional Chinese, Japanese, and French. Announcement titles, popup/top-bar HTML, and other authored content are not automatically translated for recipients.
