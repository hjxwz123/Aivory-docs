...
![Aivory conversation artifact: GDP chart dashboard with a Global_GDP_2025_World_Bank.pptx download card](/img/chat-artifact-dashboard.jpg)
...
When you enter a workspace, its administrators can show a popup or a top bar with team updates. If reading is required, wait five seconds before closing the popup. “Don't show again” remembers the current popup version in this browser; closing the bar remembers its separate version. These choices do not sync across devices, and personal space does not display workspace announcements. See [Workspace announcements](../admin/workspace-announcements.mdx) for the complete behavior.
